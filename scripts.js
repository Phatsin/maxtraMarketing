...
Linkสมัคร : https://maxtrarich.com/",
  ...
  promotion3: {
    ...
    text: "โปรโมชั่นนี้สิ้นสุดแล้วค่ะ",
...
- หากทำการเทรดครบตามข้อกำหนดแล้ว ต้องการดำเนินการถอนเงิน กรุณาติดต่อเจ้าหน้าที่เพื่อทำการตรวจสอบ",
  ...
  promotion6: {
    title: "ชวนเพื่อน 10%",
    text: "โปร 4.4 ฝากเงิน 444USD รับเครดิตโบนัส 100USD \n\
เงื่อนไขโปรโมชั่น\n\
- เพียงฝากเงิน  444 USD ภายในวันที่ 11-17 เมษายน 2565 รับทันทีโบนัสเครดิต 100 USD \n\
- สำหรับผู้ใช้งานบัญชี Standard เท่านั้น\n\
- สามารถเข้าร่วมได้ทั้งลูกค้าใหม่ และลูกค้าเดิม\n\
- ไม่จำกัดระยะเวลาการใช้เครดิต\n\
- โบนัสเครดิตจะถูกยกเลิกโดยอัตโนมัติ ในกรณี Equity อยู่ในระดับที่โดน Stop Out และเมื่อมีการถอนเงิน\n\
- ไม่มีเงื่อนไขสำหรับการทำ Lot หรือถอนเงิน\n\
*** ไม่สามารถทำการเทรด Hedging/Square  เครดิตโบนัสจะเข้าสู่บัญชีเทรดโดยอัตโนมัติ   หากพบปัญหาสามารถติดต่อเจ้าหน้าที่บริการได้ทุกช่องทาง",
    image: ["images/promotion6.jpg"]
  },
